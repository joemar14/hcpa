...
if (empty($_POST["Phone"])) {
  ...
  if ($name_error == '' and $email_error == '' and $phone_error == '' and $department_error == ''){
	  ...
	  if($department == 'Sales'){
      $to = 'sales@hondapang.com.ph, mkking@hondapang.com.ph, jmcasilang@hondapang.com.ph';
	  }
	  elseif($department == 'Service'){
      $to = 'service@hondapang.com.ph, jmcasilang@hondapang.com.ph';
	  }
	  elseif($department == 'Parts'){
      $to = 'parts@hondapang.com.ph, cgeronimo@hondapang.com.ph, jmcasilang@hondapang.com.ph';
          }
	  else{
